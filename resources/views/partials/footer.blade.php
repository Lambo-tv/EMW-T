    ...
    <div class="footer__wrapper">
        <section class="footer__section">
            ...
            <i>
                ...
                <img src="/img/logo9.png" alt="eMuwarez" class="footer__icon" style="width: 250px;">
                </section>
                <section>
                <a title="Apoya a eMuwarez" href="https://emuwarez.it/pages/8"><img src="https://emuwarez.it/img/dona2.png" alt="Colabora con eMuwarez" class="footer__icon" style="width: 250px;">    
            </p> 
        </section> -->
    ...
    <div class="footer__wrapper">
        <section class="footer__section">
            <h2 class="footer__section-title">
                ...
                <img src="/img/logo15.png" alt="Comunidad eMuwarez" class="footer__icon" style="width: 200px;">
        <!-- <img src="{{ url('/favicon.ico') }}" style="height: 80px; vertical-align: sub; horizontal-align: center;" />
                

<span class="top-nav__site-logo">{{ \config('other.title') }} </span>  -->
		</h2>

            <!-- <p class="footer__meta-description">{{ config('other.meta_description') }}</p> --> 
